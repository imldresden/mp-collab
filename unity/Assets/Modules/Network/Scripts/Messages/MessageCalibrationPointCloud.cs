...
{
    public class MessageCalibrationPointCloud : IMessage
    {
        public static MessageContainer.MessageType Type = MessageContainer.MessageType.CALIBRATION_POINT_CLOUD_DATA;

        public PointCloudDataFrame Data;

        public MessageCalibrationPointCloud(PointCloudDataFrame data)
        {
            Data = data;
        }
        ...
        public static MessageCalibrationPointCloud Unpack(MessageContainer container)
        {
            ...
            var Result = new MessageCalibrationPointCloud(DeserializeData(container.Payload));
            return Result;
        }
    }
}