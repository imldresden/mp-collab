...
namespace IMLD.MixedReality.UI
{
    ...
    public class SessionListButton : MonoBehaviour
    {
        ...
        /// </summary>
        private NetworkServiceDescription sessionInfo;
        ...
        public void SetSessionInfo(NetworkServiceDescription sessionInfo)
        {
            this.sessionInfo = sessionInfo;
            if (this.sessionInfo != null)
            {
                TextMesh.text = this.sessionInfo.Description;
